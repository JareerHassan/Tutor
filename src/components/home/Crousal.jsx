        ...
        <section className="max-w-7xl mx-auto px-6 py-20 font-sans overflow-hidden">
            <div className="flex flex-col lg:flex-row items-center gap-5">
                ...
                <div className="lg:w-1/3 text-left">
                    <h2 className="text-4xl md:text-4xl font-bold text-[#1e293b] mb-6 leading-tight">
                        Meet Our  Tutors
                    </h2>
                    <p className="text-slate-600 text-md leading-relaxed">
                        A trusted platform for educators who care about students and support families along the way. Browse profiles, compare ratings and availability, and book the tutor who best fits your goals and schedule.                    </p>
                </div>
                    ...
                    >
                        {tutors.map((tutor, index) => (
                            <SwiperSlide key={`${tutor.id}-${index}`}>
                                {({ isActive }) => (
                                    <div
                                        className={`relative transition-all duration-700 rounded-[2.5rem] overflow-hidden flex flex-col items-center shadow-xl
                                          ${tutor.bgColor} 
                                          ${isActive ? 'h-[480px] opacity-100 scale-100' : 'h-[400px] opacity-40 scale-95'}
                                        `}
                                    >
